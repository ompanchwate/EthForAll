...
export const Navbar = () => {
    return (
        ...
        <nav className='z-999 fixed flex items-center justify-between px-5 shadow-black shadow-sm bg-transparent backdrop-blur-md  w-screen font-roboto z-999'>
            <div className='flex  justify-center items-center'>
                <Link to='/' className='p-5 font-bold text-white tracking-wider text-2xl font-righteous'>ENS MARKETPLACE</Link>
            ...
            <button className='p-2 m-3 px-15 text-white mr-10 tracking-wider border-2 border-slate-600 rounded-full w-40 hover:bg-[#39ff14] hover:text-black hover:scale-105 transition duration-200 cursor-pointer font-roboto hover:font-semibold'>
                Connect
            </button>
